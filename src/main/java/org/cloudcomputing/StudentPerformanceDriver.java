...
public class StudentPerformanceDriver {
  ...
  public static void main(String[] args) throws Exception {
    if (args.length != 2) {
      System.err.println("Usage: StudentPerformanceDriver <input path> <output base path>");
      System.exit(-1);
    }
    ...
    FileOutputFormat.setOutputPath(job1, new Path(outputBase + "_job1_GenderSchoolType_GPAClass"));
    ...
    FileOutputFormat.setOutputPath(job2, new Path(outputBase + "_job2_SchoolTypeLocale_InternetAccess"));
    ...
    FileOutputFormat.setOutputPath(job3, new Path(outputBase + "_job4_FreeTimePartTime_GPAClass"));
    ...
    FileOutputFormat.setOutputPath(job4, new Path(outputBase + "_job4_InternetRelationship_GPAClass"));
